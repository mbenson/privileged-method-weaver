 ...
 */
package com.github.mbenson.privileged.weaver;
 ...
 */
public abstract class PrivilegedMethodWeaver<SELF extends PrivilegedMethodWeaver<SELF>> {
    ...
    public PrivilegedMethodWeaver(ClassPool classPool) {
        this(Policy.DYNAMIC, classPool);
    }

    public PrivilegedMethodWeaver(Policy policy, ClassPool classPool) {
